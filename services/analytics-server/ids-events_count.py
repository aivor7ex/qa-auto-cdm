"""
Test for the /api/ids-events/count endpoint.
"""
import pytest
import random
import string
...
def api_response(api_client):
    ...
    """
    response = api_client.get("/ids-events/count")
    return response
...
def test_endpoint_handles_unexpected_params(api_client, params, attach_curl_on_fail):
    with attach_curl_on_fail("/ids-events/count", params, method="GET"):
        response = api_client.get("/ids-events/count", params=params)
