...
LAG_LIST_ITEM_SCHEMA = {
    ...
    "required": ["index", "cmd", "res"]
}

ROOT_SCHEMA = {
    "type": "array",
    "items": LAG_LIST_ITEM_SCHEMA
}
...
def test_getlaglist2_parametrized(api_client, attach_curl_on_fail, param, value):
