...
ENDPOINT = "/routers/ospf/neighbors/count"
SERVICE = SERVICES["centec"]
PORT = SERVICE["port"]
BASE_PATH = SERVICE["base_path"]
HOST = SERVICE.get("host", "127.0.0.1")

OSPF_NEIGHBORS_COUNT_SCHEMA = {
    "type": "object",
    "properties": {
        "count": {"type": "integer"}
    },
...
def test_neighbors_count_parametrized(api_client, attach_curl_on_fail, param, value):
    ...
    with attach_curl_on_fail(ENDPOINT, params, None, "GET"):
        ...
        validate(instance=json_data, schema=OSPF_NEIGHBORS_COUNT_SCHEMA) 