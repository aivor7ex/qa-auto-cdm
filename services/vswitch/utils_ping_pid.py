...
The test suite for the vswitch service's /utils/ping/pid endpoint.

This suite validates the /utils/ping/pid endpoint. In the current test environment,
it's expected that the 'ping' process is not running, so the API should return a
...
def test_ignores_params(api_client, response_data, param, value):
    ...
    try:
        ...
        # This endpoint should consistently return 404 as the ping process is not running
