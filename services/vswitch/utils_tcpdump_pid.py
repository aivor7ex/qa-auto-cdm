...
The test suite for the vswitch service's /utils/tcpdump/pid endpoint.

This suite validates the /utils/tcpdump/pid endpoint. In the current test environment,
it's expected that the 'tcpdump' process is not running, so the API should return a
...
def test_ignores_params(api_client, response_data, param, value):
    ...
    try:
        ...
        # This endpoint should consistently return 404 as the tcpdump process is not running
